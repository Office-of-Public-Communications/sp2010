                    ...
                    draw: function (t) {
                        ...
                        if (i.display) {
                            var o = e.ctx,
                                ...
                                _ = "bottom" === i.position ? e.top + I : e.bottom - w - I,
                                O = "bottom" === i.position ? e.top + I + w : e.bottom + I;
        ...
        var e = 240,
            i = function () {
                ...
                return _createClass(i, [{
                    ...
                    value: function () {
                        var e = this;
                        var $slideOut = $('#slide-out.side-nav').parent();
                        this.$sidenavOverlay = $('<div id="sidenav-overlay"></div>'), this.$sidenavOverlay.css("opacity", 0).on("click", function () {
                            e.removeMenu()
                        }), $slideOut.append(this.$sidenavOverlay)
                    }
                }, {
                    ...
                    value: function () {
                        ...
                        this.$element.on("click", function (i) {
                            if (i.preventDefault(), !0 === e.menuOut) e.menuOut = !1, e.removeMenu();
                                ...
                                e.$sidenavOverlay = t('<div id="sidenav-overlay"></div>'), $slideOut.append(e.$sidenavOverlay);
                                var n = [];
                    ...
                    value: function () {
                        ...
                        "left" === this.options.edge ? (this.$menu.css("transform", "translateX(-100%)"), this.$dragTarget.css({
                            ...
                            right: 0
                        })), this.$menu.hasClass("fixed") && (window.innerWidth > 1440 && this.$menu.css("transform", "translateX(0)"), t(window).resize(function () {
                            if (window.innerWidth > 1440) e.$sidenavOverlay.length ? e.removeMenu(!0) : e.$menu.css("transform", "translateX(0%)");
                            else if (!1 === e.menuOut) {
...
! function (t) {
    ...
    function (t) {
        ...
        return t = $.extend({
            ...
            var e, i = $(this),
                n = t.data;
            Object.keys(n).length && (e = $('<ul class="mdb-autocomplete-wrap"></ul>')).insertAfter($(this)), i.on("keyup", function (t) {
                var o = i.val();
                if (e.empty(), o.length)
                    for (var a in n)
                        if (-1 !== n[a].toLowerCase().indexOf(o.toLowerCase())) {
                            var r = $("<li>".concat(n[a], "</li>"));
                            e.append(r)
                        } 13 === t.which && (e.children(":first").trigger("click"), e.empty()), 0 === o.length ? $(".mdb-autocomplete-clear").css("visibility", "hidden") : $(".mdb-autocomplete-clear").css("visibility", "visible")
            }), e.on("click", "li", function () {
                i.val($(this).text()), e.empty()
            }), $(".mdb-autocomplete-clear").on("click", function (t) {
                t.preventDefault(), i.val(""), $(this).css("visibility", "hidden"), e.empty(), $(this).parent().find("label").removeClass("active")
            })
        })
